import random
# LISTAS PARA DEFINIR A VIDA, ATAQUE MINIMO, ATAQUE MÁXIMO,
# ACERTO MINIMO E ACERTO MÁXIMO DO GUERREIRO, DO MAGO E DO LADINO
...
def jogo():
    print(
        "Seja bem vindo ao PvP entre Guerreiros, Magos e Ladinos!")  #MENSAGEM DE BOAS-VINDAS
    print()
...
#USUARIO DEFINE A CLASSE DO JOGADOR 2
    ...
    elif escolha_classe_jogador2 == 3:
        print("O jogador 2 é um Ladino!")
        print()
        vida_jogador2 = ladino[0]  
        ataque_minimo_jogador2 = ladino[1]  
        ataque_maximo_jogador2 = ladino[2]  
...
#AQUI COMEÇA A BATALHA
    ...
    #SE A ESCOLHA DO JOGADOR1 FOR 1, ELE ATACARÁ USANDO ATAQUE MINIMO
        if escolha_ataque_jogador1 == 1:
            ...
            print("O número do dado é:", dado)
            if dado >= acerto_minimo_jogador1:
                #ataque_jogador1 = ataque_minimo_jogador1
                vida_jogador2 -= ataque_minimo_jogador1
                print(
                    f"O jogador 2 recebeu {ataque_minimo_jogador1} de dano e está com {vida_jogador2} de vida!"
                )
                print()
            else:
    ...
    #SE A ESCOLHA DO JOGADOR1 FOR 2, ELE ATACARÁ USANDO ATAQUE MAXIMO
            ...
            if dado >= acerto_maximo_jogador1:
                ...
                vida_jogador2 -= ataque_maximo_jogador1
                print(
                    f"O jogador 2 recebeu {ataque_maximo_jogador1} de dano e está com {vida_jogador2} de vida!"
                )
                print()
            else:
                print("jogador 1 errou o ataque!")
    ...
    #SE A ESCOLHA DO JOGADOR2 FOR 1, ELE ATACARÁ USANDO ATAQUE MINIMO
        if escolha_ataque_jogador2 == 1:
            ...
            if dado >= acerto_minimo_jogador2:
                ...
                vida_jogador1 -= ataque_minimo_jogador2
                print(
                    f"O jogador 1 recebeu {ataque_minimo_jogador2} de dano e está com {vida_jogador1} de vida!"
                )
            else:
                print("jogador 2 errou o ataque!")
                print()

    #SE A ESCOLHA DO JOGADOR2 FOR 1, ELE ATACARÁ USANDO ATAQUE MAXIMO
        elif escolha_ataque_jogador2 == 2:
            dado = random.randint(1, 20)  #DADO DE 20 LADOS
            print("O número do dado é:", dado)
            if dado >= acerto_maximo_jogador2:
                #ataque_jogador2 = ataque_maximo_jogador2
                vida_jogador1 -= ataque_maximo_jogador2
                print(
                    f"O jogador 1 recebeu {ataque_maximo_jogador2} de dano e está com {vida_jogador1} de vida!"
                )
            else:
                print("jogador 2 errou o ataque!")
                print()
